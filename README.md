...
Apache Solr Kubernetes Operator based on Operator framework SDK.
...
## Description
The Solr Operator manages Solr clusters deployed to Kubernetes and automates tasks related to operating a Solr cluster. 
It provides a full management life-cycle for Solr, including deployment, upgrades, scaling, and configuration changes.